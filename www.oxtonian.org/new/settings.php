...
$settings['apass']='SocialistAlliance';

/* Website title */
$settings['website_title']="Oxtonian.org - The New Tim Oxton's Valedictory Web Site";

/* Website URL */
$settings['website_url']='/new/';

/* Guestbook title */
$settings['gbook_title']="Tim's Guestbook";

/* Your e-mail address. */
$settings['admin_email']='tim.oxton@btinternet.com';

/* URL of the gbook.php file. */
$settings['gbook_url']='/new/gbook.php';

/* If you want to use a logical anti-SPAM question type it here */
$settings['spam_question']='Type the result of <b>"2+2"</b> below to show you are not a robot:';
...
$settings['logfile']='gbook_entries.txt';
...
$settings['filter_sum']='asakjsjaksj';
